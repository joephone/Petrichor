...
public class MultiLanguageUtil {
    ...
    public static void setConfiguration(Context context) {
        ...
        Locale locale = null;
        String spLanguage = SPUtils.getInstance().getString(Global.SP_KEY.LOCALE_LANGUAGE);
        String spCountry = SPUtils.getInstance().getString(Global.SP_KEY.LOCALE_COUNTRY);
    ...
    public static void saveLanguageSetting(Context context, Locale locale) {
        SPUtils.getInstance().put(Global.SP_KEY.LOCALE_LANGUAGE, locale.getLanguage());
        SPUtils.getInstance().put(Global.SP_KEY.LOCALE_COUNTRY, locale.getCountry());
    }
    ...
    public static boolean isSameWithSetting(Context context) {
        ...
        String sp_language = SPUtils.getInstance().getString(Global.SP_KEY.LOCALE_LANGUAGE);
        String sp_country = SPUtils.getInstance().getString(Global.SP_KEY.LOCALE_COUNTRY);
