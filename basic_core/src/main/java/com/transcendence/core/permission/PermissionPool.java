...
public final class PermissionPool {
    ...
    public static final class GROUP {
        ...
        public static final String[] STORAGE = new String[]{
                PermissionPool.READ_EXTERNAL_STORAGE,
                PermissionPool.WRITE_EXTERNAL_STORAGE};

        /** 日历权限 */
        public static final String[] CALENDAR = new String[]{
                PermissionPool.READ_CALENDAR,
                PermissionPool.WRITE_CALENDAR};

        /** 联系人权限 */
        public static final String[] CONTACTS = new String[]{
                PermissionPool.READ_CONTACTS,
                PermissionPool.WRITE_CONTACTS,
                PermissionPool.GET_ACCOUNTS};

        /** 传感器权限 */
        public static final String[] SENSORS = new String[] {
                PermissionPool.BODY_SENSORS,
                PermissionPool.ACTIVITY_RECOGNITION};
        ...
        /** 存储权限 */
        public static final String[] YJT_SPLASH = new String[]{
                PermissionPool.MANAGE_EXTERNAL_STORAGE,
                PermissionPool.READ_PHONE_STATE};


        /** 存储权限 */
        public static final String[] MANAGE_EXTERNAL = new String[]{
                PermissionPool.MANAGE_EXTERNAL_STORAGE};

        /** 存储权限 */
        public static final String[] PETRICHOR = new String[]{
                PermissionPool.MANAGE_EXTERNAL_STORAGE,
                PermissionPool.ACCESS_FINE_LOCATION,
                PermissionPool.ACCESS_COARSE_LOCATION};
    }
