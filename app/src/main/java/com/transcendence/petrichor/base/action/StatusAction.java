package com.transcendence.petrichor.base.action;
...
public interface StatusAction {
    ...
    default void showEmpty() {
        showLayout(R.drawable.ic_empty, R.string.status_layout_no_data, null);
    }
    ...
    default void showError(View.OnClickListener listener) {
        ...
        showLayout(R.drawable.ic_error, R.string.status_layout_error_request, listener);
    }
