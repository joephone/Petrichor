package com.transcendence.petrichor.base.adapter;
...
import com.transcendence.core.adapter.BaseAdapter;
 ...
 */
public abstract class PetrichorBaseAdapter<T> extends BaseAdapter<BaseAdapter<?>.ViewHolder> {
    ...
    public PetrichorBaseAdapter(@NonNull Context context) {
        super(context);
    }
