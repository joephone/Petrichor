package com.transcendence.petrichor.ui.loc.fragment;
...
/**
 * @Author Joephone on 2021/12/15 0015 下午 2:20
 * @E-Mail Address：joephonechen@gmail.com
 * @Desc
 * @Edition 1.0
 * @EditionHistory
 */
public class WeixinLocFragment extends PetrichorBaseFragment<PetrichorBaseActivity> {
    ...
    public static WeixinLocFragment newInstance() {
        WeixinLocFragment fragment = new WeixinLocFragment();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_weixin_loc;
    }
...
//                        Toast.makeText(MainActivity.this, "定位", Toast.LENGTH_SHORT).show();
                        mIvLocation.setImageResource(R.mipmap.ic_marker_move);
                        if (null != mSelectByListMarker) {
                            mSelectByListMarker.setVisible(false);
                        }
                        if (null == location) {
...
//        mBtSend.setOnClickListener(mOnClickListener);
    ...
    private void initDatas(Bundle savedInstanceState) {
        ...
        mList = new ArrayList<>();
        mAddressAdapter = new AddressAdapter(getActivity(), mList);
        ...
        if (requestCode == 321) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                if (grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast toast = Toast.makeText(getActivity(), "请开启权限", Toast.LENGTH_SHORT);
